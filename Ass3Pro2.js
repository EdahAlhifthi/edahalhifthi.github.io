...
var helixObject = {color: "Blue",type: "Sphere", radius: 2, nbrSolids: 50, angle: Math.PI / 4, distance: 0.5
};
...
gui.add(helixObject, 'type', ['Sphere', 'Cube', 'Cylinder', 'Icosahedron', 'Dodecahedron']).listen().onChange(function (value) { createScene(); });
...
function createScene() {
    ...
    else if (helixObject.type == "Cube")
        geom = new THREE.CubeGeometry(1);
    else if (helixObject.type == "Cylinder")
        geom = new THREE.CylinderGeometry(1);
